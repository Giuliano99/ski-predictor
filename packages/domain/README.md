...
Die technischen Datenverträge liegen unter `schemas`. Dazu gehören Tipprunde, Tippabgabe, Startliste, Rennergebnis, Athletenidentität, Extraktionsauftrag, normalisiertes Renndokument, Wochenendauswertung, Saisonrangliste und Spielleiter-Workflow. Eine vollständige Demo-Tipprunde steht unter [`examples/tip-round.example.json`](examples/tip-round.example.json).
